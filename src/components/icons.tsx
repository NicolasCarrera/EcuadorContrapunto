export function SparklesIcon() {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' className='icon icon-tabler icons-tabler-outline icon-tabler-sparkles'>
...
export function FileUploadIcon() {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='currentColor' className='icon icon-tabler icons-tabler-filled icon-tabler-file-upload'>
      <path stroke='none' d='M0 0h24v24H0z' fill='none'/>
...
export function CheckIcon({ className }: { className?: string }) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' className={`icon icon-tabler icons-tabler-outline icon-tabler-circle-check ${className || ''}`}>
      <path stroke='none' d='M0 0h24v24H0z' fill='none'/>
...
export function SpinnerIcon() {
  return (
    <svg aria-hidden='true' role='status' className='inline w-4 h-4 me-3 text-gray-900 animate-spin' viewBox='0 0 100 101' fill='none' xmlns='http://www.w3.org/2000/svg'>
